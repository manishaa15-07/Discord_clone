...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'yourgmail@gmail.com',      // your Gmail here
        pass: 'abcd efgh ijkl mnop'       // your App Password here
    }
});
...
// Stores reset tokens separately
...
async function sendResetEmail(email, displayName, resetToken) {
    // This is the link Person 5 will build in the frontend
    // For now it points to your test HTML file
    const resetLink = `http://localhost:5500/test.html?token=${resetToken}`;
...
app.post('/forgot-password', async (req, res) => {
    ...
    sendResetEmail(user.email, user.displayName, resetToken);
